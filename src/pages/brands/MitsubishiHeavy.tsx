...
const MitsubishiHeavy = () => {
  const products = [
    {
      name: "Heavy Duty Commercial AC",
      description: "Industrial-grade air conditioning for demanding environments",
      image: commercialHVAC,
      features: ["Robust Construction", "High Cooling Capacity", "Extended Lifespan"]
    },
    {
      name: "Floor Standing Units",
      description: "Powerful floor-mounted ACs for large spaces",
      image: floorStandingAC,
      features: ["High Airflow", "Easy Installation", "Commercial Grade"]
    },
    {
      name: "Chiller Systems",
      description: "Centralized cooling solutions for large buildings",
      image: chillerSystem,
      features: ["Energy Efficient", "Centralized Control", "Scalable Design"]
    }
  ];
